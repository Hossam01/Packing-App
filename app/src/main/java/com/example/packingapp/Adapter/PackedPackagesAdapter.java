...
public class PackedPackagesAdapter extends RecyclerView.Adapter<PackedPackagesAdapter.MyViewHolder> {

    private List<PackedPackageModule> ItemsList;
    PackedPackageModule  packedPackageModule;
    ...
    public PackedPackagesAdapter(List<PackedPackageModule> moviesList) {
   ...
   // @SuppressLint("ResourceAsColor")
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
         packedPackageModule = ItemsList.get(position);
         if (packedPackageModule.getChecked_Item() ==null){
             packedPackageModule.setChecked_Item(false);
         }
        if (packedPackageModule.getChecked_Item()){
  ...
  //          holder.main_linear_of_item.setBackgroundColor(R.color.third_white);
    ...
    //                holder.main_linear_of_item.setBackgroundColor(R.color.third_white);
        ...
        holder.txt_tracking_number.setText(packedPackageModule.getTrackingNumber());
...
//        holder.txt_nu.requestFocus();
    ...
    public List<PackedPackageModule> ReturnListOfPackages(){
