        ...
        try {
            ...
            for (int i=0;i<30;i++)
            {
                if (i<orderDataModuleDBHeaderkist.size())
                {
                    ...
                    Log.e("size",""+orderDataModuleDBHeaderkist.size());
                }
            }
            ...
            if (printerLanguage == PrinterLanguage.ZPL) {
                ...
                String currentString = orderDataModuleDBHeaderkist.get(0).getTrackingNumber();
                String[] separated = currentString.split("-");

                 OrderDataModuleDBHeader orderDataModuleDBHeader= database.userDao().getHeaderToUpload(separated[0]);
                try {
                    ...
                    String name = "^XA" +
                            ...
                            "^FO500,465^CI28^AZN,20,15^FD" + separated[0] + "^FS" +
                            ...
                            "^CF0,10" +
                            "^AZN,35,20^AAN,15,10^FO90,320^BCN,85,Y,N^FD>"+" "+orderDataModuleDBHeader.getOrder_number()+"^FS^PQ1" +
                            "^FO600,320^BQN,2,4^FD"+"   "+orderDataModuleDBHeader.getOrder_number()+"^FS" +
